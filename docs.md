...
2. После инциализации проекта прописываем в консоли `npm install electron --save-dev`
3. Импортируем проект с текущего репозитория в папку с нашим инициализированным проектом
4. Запуск программы:
   ```
   npm run start
   ```
